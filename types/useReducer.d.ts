...
import { EnhancedStore, ReducerOptions } from "./context";
export declare function useHookedReducer<S, A>(reducer: Reducer<S, A>, initialState: S, store: EnhancedStore, reducerId: string | number, options?: ReducerOptions): [S, Dispatch<A>];
